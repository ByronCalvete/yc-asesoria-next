        ...
        <section id="hero" className="max-w-5xl mx-auto flex flex-col-reverse justify-center sm:flex-row p-6 items-center gap-8 sm:gap-10 mb-12 scroll-mt-40 widescreen:section-min-height tallscreen:section-min-height">
          <article className="sm:w-2/3">
            ...
            <div className="mt-8 flex gap-4">
              <button className="bg-yc-red active:bg-[#C53337] px-3 py-4 text-md md:text-xl rounded-lg hover:opacity-90 text-white w-full md:w-2/3 sm:w-5/6 border border-black shadow-md hover:shadow-xl"><Link href='/asesoria-gratuita'>Asesoría Gratuita</Link></button>
